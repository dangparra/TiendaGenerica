...
public class VentasDTO {
	...
	public VentasDTO(int codigo_venta, int cedula_cliente, int cedula_Usuario, double ivaventa, double total_venta, double valor_venta) {
		super();
		this.codigo_venta = codigo_venta;
		this.cedula_cliente = cedula_cliente;
		cedula_usuario = cedula_Usuario;
	...
	public void setCodigo( int codigo_venta) {
		this.codigo_venta = codigo_venta;
	}
